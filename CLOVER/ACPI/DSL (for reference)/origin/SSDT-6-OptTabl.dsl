 ...
 *
 * Disassembly of SSDT-6-OptTabl.aml, Sun Aug 26 08:57:01 2018
 *
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_PR_.CPU4._PPC, IntObj)    // (from opcode)
    External (_PR_.CPU5._PPC, IntObj)    // (from opcode)
    External (_PR_.CPU6._PPC, IntObj)    // (from opcode)
    External (_PR_.CPU7._PPC, IntObj)    // (from opcode)
    ...
    Scope (\_SB.PCI0.RP01.PEGP)
    {
        Method (GC6I, 0, Serialized)
        {
            ...
            While (LNotEqual (\_SB.PCI0.LKS1, Zero))
            {
                Sleep (One)
            }
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x20)
                {
                    ...
                    If (And (\_PR.CFGD, 0x00400000))
                    {
                        Or (RET1, 0x00800000, RET1)
                    }
                    Else
                    {
                        And (RET1, 0x007FFFFF, RET1)
                    }
